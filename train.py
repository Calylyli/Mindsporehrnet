...
def parse_args():
    ...
    parser.add_argument("--data_url", type=str, default="./cityscapes", help="Storage path of dataset in OBS.")
    parser.add_argument("--dataset", type=str, default="cityscapes",
                        help="Dataset.")
    parser.add_argument("--train_url", type=str, default="modelresult", help="Storage path of training results in OBS.")
